 ...
 * @author Shai Almog
 */
public class NetiFiDashStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "NetiFiDash";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new NetiFiDashStub());
    }
