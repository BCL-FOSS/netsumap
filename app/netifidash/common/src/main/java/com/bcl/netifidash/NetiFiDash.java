...
public class NetiFiDash extends Lifecycle {
    ...
    public void runApp() {
        ...
        socketTest.addActionListener((evt) -> {
            Socket.connect(socketHost.getText(), Integer.getInteger(socketPort.getText()), new SocketConnection() {
                @Override
                public void connectionError(int i, String s) {

                    ToastBar.showErrorMessage(s);
                ...
                public void connectionEstablished(InputStream inputStream, OutputStream outputStream) {
                    ...
                    ToastBar.showMessage("WebSocket Connection Successful", FontImage.MATERIAL_CHECK);
